...
#$JAVA_PATH/java -Xmx12g -Djava.io.tmpdir=/scratch \
...
#$BCFTOOLS_PATH/bcftools view -G $out_dir/$project.$chr.GT.vcf | \
# vcflength | $JAVA_PATH/java -jar $SNPEFF_PATH/SnpSift.jar varType - | vcfTrimMNP.py  | sed '1,/^##/d' | \
